        ...
        <x-www-main>
            ...
            <div class="social-share mt-4">
                <div class="d-flex justify-content-end gap-3">
                    ...
                    <!-- 트위터 공유 버튼 -->
                    <a href="https://twitter.com/intent/tweet?url={{ urlencode(request()->url()) }}&text={{ urlencode($row->title) }}"
                    ...
                    <!-- 링크드인 공유 버튼 -->
                    <a href="https://www.linkedin.com/shareArticle?mini=true&url={{ urlencode(request()->url()) }}&title={{ urlencode($row->title) }}"
