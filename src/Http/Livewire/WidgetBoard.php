...
class WidgetBoard extends Component
{
    ...
    private function initView()
    {
        if(!$this->viewLayoutFile) {
            $this->viewLayoutFile = "jiny-site-board"."::site.board_popup.widget";;
        }
        ...
        if(!$this->viewFormFile) { // 라이브와이어 외부 입력정보 최우선 처리
            ...
            {
                // 기본값
                $this->viewFormFile = "jiny-site-board"."::site.board_popup.form";
            }
        }
        ...
        if(!$this->viewCreateFile) {
            ...
            {
                // 기본값
                $this->viewCreateFile = "jiny-site-board"."::site.board_popup.create";
            }
        ...
        if(!$this->viewViewFile) {
            ...
            {
                // 기본값
                $this->viewViewFile = "jiny-site-board"."::site.board_popup.view";
            }
        ...
        if(!$this->viewEditFile) {
            ...
            {
                // 기본값
                $this->viewEditFile = "jiny-site-board"."::site.board_popup.edit";
            }
        ...
        if(!$this->viewListFile) {
            ...
            {
                // 기본값
                $this->viewListFile = "jiny-site-board"."::site.board_popup.list";
            }

            //dd($this->viewListFile);
        }
        ...
        if(!$this->viewTableFile) {
            ...
            {
                // 기본값
                $this->viewTableFile = "jiny-site-board"."::site.board_popup.table";
            }
