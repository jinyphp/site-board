...
class SiteBoardTable extends Component
{
    use WithFileUploads;
    use WithPagination;
    ...
    public function setViewList()
    {
        if(!$this->viewListFile) {
            ...
            $this->viewListFile = "jiny-site-board"."::site.board_wire.list_link";
        }
    }
    ...
    public function setViewTable()
    {
        ...
        if(!$this->viewTableFile) {
            ...
            $this->viewTableFile = "jiny-site-board"."::site.board_wire.table_link";
        }
    }
