 ...
 * Widget 계시판
 */
class SitePostWidget extends Component
{
    public $tablename;
    public $uri;
    public $widget = [];
    ...
    private function initView()
    {
        if(!$this->viewLayoutFile) {
            $this->viewLayoutFile = "jiny-site-board"."::site.post.widget";;
        }
        ...
        if(!$this->viewFormFile) { // 라이브와이어 외부 입력정보 최우선 처리
            if(isset($this->widget['view']['form'])) {
                ...
                // 기본값
                $this->viewFormFile = "jiny-site-board"."::site.post.form";
            }
        }
        ...
        if(!$this->viewCreateFile) {
            if(isset($this->widget['view']['create'])) {
                ...
                // 기본값
                $this->viewCreateFile = "jiny-site-board"."::site.post.create";
            }
        }
        ...
        if(!$this->viewViewFile) {
            if(isset($this->widget['view']['view'])) {
                ...
                // 기본값
                $this->viewViewFile = "jiny-site-board"."::site.post.view";
            }
        }
        ...
        if(!$this->viewEditFile) {
            if(isset($this->widget['view']['edit'])) {
                ...
                // 기본값
                $this->viewEditFile = "jiny-site-board"."::site.post.edit";
            }
        ...
        if(!$this->viewListFile) {
            ...
            {
                // 기본값
                $this->viewListFile = "jiny-site-board"."::site.post.list";
            }
        }
        ...
        if(!$this->viewTableFile) {
            ...
            {
                // 기본값
                $this->viewTableFile = "jiny-site-board"."::site.post.table";
            }
    ...
    public function update()
    {
        if($this->permit['update']) {
            ...
            // uploadfile 필드 조회
            /*
            $fields = DB::table('uploadfile')->where('table', $this->tablename)->get();
